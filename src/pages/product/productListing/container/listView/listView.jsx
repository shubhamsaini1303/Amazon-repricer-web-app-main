...
export default function ListView() {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Tooltip
          ...
          interactive
        >
          <div className="items-center text-left text-[#404040] leading-[13px] text-[11px] font-medium break-words whitespace-normal mt-1">
  ...
  return (
    <div onScroll={handleScroll} style={{ overflowY: "auto" }} >
      <DataTable rows={rows} columns={columns} handleDragEnd={handleDragEnd} key={getKey()} />
      {loading && (
